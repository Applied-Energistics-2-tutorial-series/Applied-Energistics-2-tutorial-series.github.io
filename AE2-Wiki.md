...
举例来说，[图2.1 AE最简单的管道（管道4）](/AE2-Wiki.md#2.相关的概念与结构实现#2.1ME管道传输#2.1.2「管道」的实现) 中的AE网络整体「结构」，实现了[管道4](broken-reference)的「概念」。
_
...
### 3.1.1「卡合成」的定义 <a href="#_toc137910915" id="_toc137910915"></a>
...
### &#x20;3.2.1 设计说明 <a href="#_toc137910920" id="_toc137910920"></a>

「伪合成」的实质，就是发起合成后，欺骗**合成储存器**，让她以为合成已经完成，从而解除“正在合成”状态。

### 3.2.2设计实现 <a href="#_toc137910921" id="_toc137910921"></a>
...
### 4.1.1设计说明 <a href="#_toc137910926" id="_toc137910926"></a>
